        ...
        <div className="relative">
          ...
          <div className="relative container mx-auto px-4 py-12 md:py-16 flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              {movie.slogan && (
                <p className="text-sm italic text-white/70 mb-3 drop-shadow-md">"{movie.slogan}"</p>
              )}
                  ...
                  {movie.lastWatchedEpisode && (
                    <div className="mt-4 bg-primary/10 p-3 rounded-md border border-primary/20">
                      ...
                      <p className="text-sm text-white">
                        Season {movie.lastWatchedEpisode.season}, Episode{' '}
                        {movie.lastWatchedEpisode.episode}:
                  ...
                  <div className="bg-secondary/10 p-6 rounded-xl border border-border/50">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {movie.cast.map((actor) => {
                        const actorEntity = getActorsByMovieId(movie.id).find(
                          (a) => a.name === actor,
                        )
                        return actorEntity ? (
                          <Link
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="bg-gradient-to-r from-yellow-950/30 to-yellow-900/10 p-5 rounded-lg border border-yellow-900/20">
                        ...
                        <div className="h-3 bg-muted rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${((movie.ratingImdb || 0) / 10) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                    ...
                    {movie.ratingKinopoisk !== undefined && (
                      <div className="bg-gradient-to-r from-orange-950/30 to-orange-900/10 p-5 rounded-lg border border-orange-900/20">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center">
                            <div className="bg-orange-500 text-black font-bold px-2 py-1 rounded text-sm mr-2">
                              KP
                            </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-sm text-muted-foreground ml-2">
                              /10 ({movie.ratingKinopoiskVoteCount?.toLocaleString() || 'N/A'}{' '}
                              votes)
                            </span>
                          </div>
                        </div>
                        <div className="h-3 bg-muted rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${((movie.ratingKinopoisk || 0) / 10) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                    ...
                    {movie.ratingGoodReview !== undefined && (
                      <div className="bg-gradient-to-r from-green-950/30 to-green-900/10 p-5 rounded-lg border border-green-900/20">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center">
                            <div className="bg-green-500 text-black font-bold px-2 py-1 rounded text-sm mr-2">
                              GR
                            </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="font-bold text-xl">
                              {movie.ratingGoodReview?.toFixed(1)}
                            </span>
                            <span className="text-sm text-muted-foreground ml-2">
                              /10 ({movie.ratingGoodReviewVoteCount?.toLocaleString() || 'N/A'}{' '}
                              votes)
                            </span>
                          </div>
                        </div>
                        <div className="h-3 bg-muted rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${((movie.ratingGoodReview || 0) / 10) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    {movie.ratingFilmCritics !== undefined && (
                      <div className="bg-gradient-to-r from-purple-950/30 to-purple-900/10 p-5 rounded-lg border border-purple-900/20">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center">
                            <div className="bg-purple-500 text-white font-bold px-2 py-1 rounded text-sm mr-2">
                              FC
                            </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="font-bold text-xl">
                              {movie.ratingFilmCritics?.toFixed(1)}
                            </span>
                            <span className="text-sm text-muted-foreground ml-2">
                              /10 ({movie.ratingFilmCriticsVoteCount?.toLocaleString() || 'N/A'}{' '}
                              votes)
                            </span>
                          </div>
                        </div>
                        <div className="h-3 bg-muted rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${((movie.ratingFilmCritics || 0) / 10) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                    ...
                    {movie.ratingRfCritics !== undefined && (
                      <div className="bg-gradient-to-r from-indigo-950/30 to-indigo-900/10 p-5 rounded-lg border border-indigo-900/20">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center">
                            <div className="bg-indigo-500 text-white font-bold px-2 py-1 rounded text-sm mr-2">
                              RFC
                            </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="font-bold text-xl">
                              {movie.ratingRfCritics?.toFixed(1)}
                            </span>
                            <span className="text-sm text-muted-foreground ml-2">
                              /10 ({movie.ratingRfCriticsVoteCount?.toLocaleString() || 'N/A'}{' '}
                              votes)
                            </span>
                          </div>
                        </div>
                        <div className="h-3 bg-muted rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${((movie.ratingRfCritics || 0) / 10) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                    ...
                    {movie.reviewsCount !== undefined && (
                      <div className="bg-gradient-to-r from-blue-950/30 to-blue-900/10 p-5 rounded-lg border border-blue-900/20">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center">
                            <span className="font-bold text-xl">
                              {movie.reviewsCount?.toLocaleString()}
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-center h-full">
                      <div className="text-center p-8">
                        ...
                        <p className="text-muted-foreground">
                          We don't have a trailer for this movie yet.
                        </p>
                      </div>
                    </div>
                  )}
