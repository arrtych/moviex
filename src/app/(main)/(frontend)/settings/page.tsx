              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Scan your library folders for new content
                    </p>
                  </div>
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Remove missing files from your library
                    </p>
                  </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={setSubtitlesLanguage}
        ...
        <TabsContent value="about">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-4">
                <p className="text-sm text-muted-foreground">
                  MovieX is a personal film library management system. It allows you to organize,
                  track, and manage your movie collection.
                </p>
              </div>
            </CardContent>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                {storageToDelete.name}" from your settings.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
