...
export default function SearchPage() {
  ...
  const allYears = Array.from(
    new Set(movies.map((movie) => new Date(movie.releaseDate).getFullYear()))
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {filters.duration < 240 && (
                  ...
                  >
                    ...
                    {Math.floor(filters.duration / 60)}h {filters.duration % 60}
                    m
                    <Button
                      variant="ghost"
                      size="icon"
            ...
            <Card>
              <CardContent className="p-4 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <label className="text-sm font-medium flex items-center gap-2">
                      <Clock className="h-4 w-4 text-primary" /> Maximum
                      Duration
                    </label>
                    <span className="text-sm text-muted-foreground">
                  ...
                  <Slider
                    ...
                    step={15}
                    onValueChange={(value) =>
                      handleFilterChange("duration", value[0])
                    }
                  />
                </div>
              </CardContent>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {["Action", "Drama", "Sci-Fi", "Comedy", "Thriller"].map(
                  (genre) => (
                    <Button
                      key={genre}
                      variant="secondary"
