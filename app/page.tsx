...
export default function Home() {
  ...
  const trendingMovies = [...movies].sort(() => Math.random() - 0.5).slice(0, trendingLimit)
  ...
  return (
    <div className="pt-16">
      ...
      <div className="container mx-auto px-4 py-8 space-y-10">
        <Suspense fallback={<div className="h-72 bg-muted animate-pulse rounded-lg" />}>
          <FilmCarousel
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                      <div className="p-4 w-full">
                        ...
                        <p className="text-sm text-white/80">Explore movies by genre</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                      <div className="p-4 w-full">
                        ...
                        <p className="text-sm text-white/80">Discover films by director</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                      <div className="p-4 w-full">
                        ...
                        <p className="text-sm text-white/80">Find movies by actor</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
