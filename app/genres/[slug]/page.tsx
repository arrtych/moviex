...
export default function GenrePage({ params }: { params: { slug: string } }) {
  ...
  const genre = genres.find((g: Genre) => g.slug === params.slug)
    ...
    <div className="pt-16">
      ...
      <div className="relative">
        ...
        <div className="relative container mx-auto px-4 py-12 md:py-16">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">{genre.name}</h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mb-6">{genre.description}</p>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {sortedMovies.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">We don't have any movies for this genre in our database yet.</p>
          </div>
        ) : viewMode === "grid" ? (
