...
import { Calendar, MapPin, Ruler, Star, Film, Instagram, Twitter, Facebook, ExternalLink } from "lucide-react"
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm md:text-base mb-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-2">({calculateAge(actor.birthDate, actor.deathDate)} years old)</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {actorMovies.length > 0 ? (
                ...
                <div className="col-span-full text-center py-12">
                  ...
                  <p className="text-muted-foreground">We don't have any movies for this actor in our database yet.</p>
                </div>
              )}
            </div>
          </TabsContent>
