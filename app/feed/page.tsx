...
import { Bookmark, Heart, Tv, Calendar, Filter, Download, Pause, CheckCircle, Trash2 } from "lucide-react"
                      ...
                      <div className="mt-4">
                        ...
                        {item.type === "download_status" && (
                          <div className="flex items-center">
                            ...
                            {item.downloadStatus === "paused" && <Pause className="h-5 w-5 text-amber-500 mr-2" />}
                            {item.downloadStatus === "deleted" && <Trash2 className="h-5 w-5 text-red-500 mr-2" />}
                            <div>
