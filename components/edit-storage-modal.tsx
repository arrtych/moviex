...
export function EditStorageModal({ open, onOpenChange, storage, isNew = false }: EditStorageModalProps) {
  ...
  const handleSave = () => {
    ...
    toast({
      ...
      description: `Storage "${name}" has been ${isNew ? "added" : "updated"} successfully`,
      variant: "default",
    })
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="py-4 space-y-4">
          <div className="space-y-2">
            ...
            <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="My Storage" />
          </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSave}>{isNew ? "Add Storage" : "Save Changes"}</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  )
